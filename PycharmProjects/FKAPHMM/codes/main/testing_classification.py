...
# Legend: HE (High Erosion), HIE (High Intermediate Erosion), IE (Intermediate Erosion), LIE (Low Intermediate Erosion),
#         LE (Low Erosion), Static,  LD (Low Deposition), LID (Low Intermediate Deposition), ID (Intermediate Deposition),
...
print(raster_A_ma_fi.min(), nodatavalue)
