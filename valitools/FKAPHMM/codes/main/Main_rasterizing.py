...
# 2. Shapefiles Paths
shape_A = str(current_dir / "shapefiles/map_A_res2.shp")
shape_B = str(current_dir / "shapefiles/map_B_res2.shp")

# 3. Raster
#  3.1 Raster paths: tif format (enter file path and file name ending with *.tif)
raster_A = str(current_dir / "rasters/map_A_res2.tif")
raster_B = str(current_dir / "rasters/map_B_res2.tif")

#  3.2 Raster paths: ascii format (enter file path and file name ending with *.asc)
raster_A_asc = str(current_dir / "rasters/map_A_res2.asc")
raster_B_asc = str(current_dir / "rasters/map_B_res2.asc")
